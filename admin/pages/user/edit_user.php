...
<head>
  ...
  <title>AdminLTE 2 | Edit User</title>
            ...
            <form role="form" action="php_action/edit.php" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama" name="nama"  value="<?php echo $data['nama_user']?>" required>
                </div>
                <div class="form-group">
                  <label for="email">Email User</label>
                  <input type="email" class="form-control" id="email" name="email"  value="<?php echo $data['email_user']?>" required>
                </div>
                <div class="form-group">
